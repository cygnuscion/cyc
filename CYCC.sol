...
contract CYCCToken is StandardToken, SafeMath {
    
    // metadata
    string  public constant name = "Cygnus Coin";
    string  public constant symbol = "CYCC";
    ...
    bool    public isFunding = true;                // 状态切换到true
        ...
        uint256 _currentSupply) public
    {
        ...
        totalSupply = formatDecimals(667000000);
